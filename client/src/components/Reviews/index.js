                ...
                <div className="row">
                    <div className="col-sm-6">
                        ...
                        <div className="card-body">
                            <i className="fa fa-comments-o fa-4x d-inline" aria-hidden="true"></i>
                    ...
                    <div className='col-md-12'>
                        <div className="card-deck mt-4">
                            <div className="card drivercard">
                                <img className="card-img-top" src="https://i.pinimg.com/736x/02/4b/c6/024bc6921cf802ea89285d38c8b8a667.jpg" alt="Card image cap"/>
                                <div className="card-body">
                            ...
                            <div className="card drivercard">
                                <img className="card-img-top" src="https://di2ponv0v5otw.cloudfront.net/posts/2018/12/19/5c1b215d72769b2f1481108f/s_5c1b215fe944bae719d86ed3.jpeg" alt="Card image cap"/>
                                <div className="card-body">
                            ...
                            <div className="card drivercard">
                                <img className="card-img-top" src="https://atozhairstyles.com/wp-content/uploads/2017/07/15-Golden-Locks.jpg" alt="Card image cap"/>
                                <div className="card-body">
